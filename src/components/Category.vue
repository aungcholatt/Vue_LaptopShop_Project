                  ...
                  <v-list-item three-line class="text-center">
                    <v-list-item-content>
                      ...
                      <v-list-item-subtitle
                        :class="active ? '#330066--text' : 'black--text'"
                        class="caption mt-4"
...
export default {
  data: () => ({
    categories: [
      { img: "01.png", title: "Location" },
      { img: "02.png", title: "Messsage" },
      { img: "3.png", title: "Phone" },
      { img: "4.png", title: "Search" },
      { img: "5.png", title: "Office" },
      { img: "6.png", title: "factory" },
    ],
  }),
};
</script>
