        ...
        <v-col cols="12">
          <v-card class="mx-auto rounded-xl" flat>
            <v-img src="cover2.png" max-height="100%" max-width="100%" contain>
              <v-card-title class="ml-4 mt-10">
                <h2 class="title1">Order by</h2>
              </v-card-title>
              <v-card-text class="ml-10">
                <h3 class="#330066--text">Free Delivery</h3>
              </v-card-text>
              <v-card-text class="ml-10">
                <v-row>
                  <v-col cols="4">
          ...
          <v-toolbar flat color="transparent">
            <v-toolbar-title class="text-h6">Contact Us</v-toolbar-title>
            <v-spacer></v-spacer>
            <v-btn-toggle v-model="toggle_exclusive" group color="#660066">
              <v-btn>
          ...
          <v-toolbar flat color="transparent" class="mt-5">
            ...
            <v-spacer></v-spacer>
            <v-btn rounded color="#330066" dark class="px-8">See All</v-btn>
          </v-toolbar>
          <Product />
          <v-card flat color="#330066" class="rounded-xl mt-8">
          ...
          >
            <v-row>
              <v-col cols="12" xs="12" sm="12" md="5">
                <v-card
                  class="rounded-xl mt-n17 ml-16 mobile"
                  outlined
                  flat
                  height="340"
                  width="180"
